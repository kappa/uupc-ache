...
/*--------------------------------------------------------------------*/
 ...
 /*
  *   $Id: hostable.h 1.8 1994/05/08 21:46:58 ahd Exp $
  *
  *   $Log: hostable.h $
...
/* Ache ============================================================== */
#define HOSTLEN   7           /* max length of host name without '\0'  */
...
/* Ache ============================================================== */
      ...
      int	hattempts;	 /* connection attempts (this run) */
#define MIN_IDLE	5	 /* sec. */
      long	idlewait;	 /* idle wait time, if queue not moved */
      char	*login;
      char 	*password;		
   };
