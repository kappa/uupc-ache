...
/*
 *    $Id: expath.c 1.14 1994/02/19 04:40:47 ahd Exp $
 *
 *    Revision history:
 *    $Log: expath.c $
...
printmsg(20, "expand_path: path = %s, save = %s, p = %s", path, save, p);
      if ( p == NULL )
      {
         printerr( "expand_path", path );
         return NULL;
      }
